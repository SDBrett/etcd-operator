...
func TestMain(m *testing.M) {
	...
	testEnv.Setup(
		// create KinD cluster
		createKindCluster(kindCluster, clusterVersion),

		createDockerImage(),
		// prepare the resources
		loadDockerImage(kindCluster),

		// install prometheus and cert-manager
		loadAdditionalOperators(),
...
func createKindCluster(kindCluster *kind.Cluster,
	clusterVersion support.ClusterOpts) func(ctx context.Context,
	cfg *envconf.Config) (context.Context, error) {

	return func(ctx context.Context, cfg *envconf.Config) (context.Context, error) {
		if ctx, err := envfuncs.CreateClusterWithOpts(kindCluster,
			kindClusterName,
			clusterVersion)(ctx, cfg); err != nil {
...
func createDockerImage() func(ctx context.Context,
	cfg *envconf.Config) (context.Context, error) {
...
func loadDockerImage(kindCluster *kind.Cluster) func(ctx context.Context,
	cfg *envconf.Config) (context.Context, error) {

	return func(ctx context.Context, cfg *envconf.Config) (context.Context, error) {
		log.Println("Loading docker image into kind cluster...")
		if err := kindCluster.LoadImageArchive(ctx, "etcdOperator.tar"); err != nil {
...
func loadAdditionalOperators() func(ctx context.Context,
	cfg *envconf.Config) (context.Context, error) {
...
func deployOperator() func(ctx context.Context,
	cfg *envconf.Config) (context.Context, error) {

	return func(ctx context.Context, cfg *envconf.Config) (context.Context, error) {
		if ctx, err := envfuncs.CreateNamespace(namespace)(ctx, cfg); err != nil {
...
func deleteKindCluster() func(ctx context.Context,
	cfg *envconf.Config) (context.Context, error) {
